...
angular.module('gujaratSamachar.adminPanel')
	.controller('AddSlideShowImageController', AddSlideShowImageController);

AddSlideShowImageController.$inject = ['FileUploader', '$uibModalInstance', '$scope'];

function AddSlideShowImageController(FileUploader, $uibModalInstance, $scope) {
	var vm = this;
